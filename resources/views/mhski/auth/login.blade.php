@extends('mhski.layouts.app2', ['class' => 'off-canvas-sidebar', 'activePage' => 'login', 'titlePage' => __('UDINUS KKI')])
      ...
      <div class="row">
        <div class="col-6">
            @if (Route::has('password.request'))
                <a href="{{ route('mhski.password.request') }}" class="text-light">
                    <small>{{ __('Forgot password?') }}</small>
                </a>
            @endif
        </div>
        <div class="col-6 text-right">
            <a href="{{ route('mhski.register') }}" class="text-light">
